...
@AllArgsConstructor
@Entity
@Table(name = "m_sandbox_recurrent_transaction")
public class SandboxRecurrentTransaction extends GenericBaseEntity {
    ...
    void prePersist() {
        ...
        if (ObjectUtils.isEmpty(recurrentTransactionId))
            recurrentTransactionId = "SBRTX_" + RandomStringUtils.randomAlphanumeric(5)
