...
public class SwaggerConfig {
    ...
    public Docket docket() {
        return new Docket(DocumentationType.SWAGGER_2)
                    ...
                    .select()
                    .apis(RequestHandlerSelectors.basePackage("com.wayapaychat.paymentgateway.controller"))
	...
	public static final ApiInfo DEFAULT_API_INFO = new ApiInfo("PAYMENT-GATEWAY-SERVICE REST API I",
			"RESTFUL PAYMENT GATEWAY API DOCUMENTATION", "1.0", "urn:tos", DEFAULT_CONTACT, "Apache 2.0",
